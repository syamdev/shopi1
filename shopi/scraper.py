...
class ShopeeSpiderJSON(scrapy.Spider):
    ...
    custom_settings = {
        ...
        'FEEDS': {'output/outputjson.json': {'format': 'json',
                                             }
                  },
        # 'LOG_ENABLED': False,
        # 'LOG_LEVEL': 'WARNING',
    ...
    def __init__(self, query='', **kwargs):  # The query variable will have the input URL.
        self.start_url = query
...
#     process.crawl(ShopeeSpiderJSON, start_url='https://shopee.co.id/api/v2/search_items/?by=price&keyword=celana&limit=20&newest=0&order=asc&page_type=search&version=2')
#     process.start()
